...
require([
	"d3/d3",
	"helpers/cm/lib/codemirror",
	"helpers/cm/addon/search/search",
	"helpers/cm/addon/search/searchcursor",
	"helpers/cm/addon/hint/show-hint",
	"helpers/cm/addon/hint/xml-hint",
	"helpers/cm/addon/fold/foldcode",
	"helpers/cm/addon/fold/foldgutter",
	"helpers/cm/addon/fold/brace-fold",
	"helpers/cm/addon/fold/xml-fold",
	"helpers/cm/addon/fold/indent-fold",
	"helpers/cm/addon/fold/markdown-fold",
	"helpers/cm/addon/fold/comment-fold",
	"helpers/cm/addon/edit/matchtags",
	"helpers/cm/addon/selection/mark-selection",
	"helpers/cm/mode/xml/xml",
	"misc",
], function(d3, CodeMirror) {
...
initLoader();
console.log("====>from render.js at loading")
